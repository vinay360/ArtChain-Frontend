...
const Market = () => {
  return (
    <>
      <Navbar />
      <div>
        <div class="text-gray-100 font-bold text-2xl tracking-wider sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl sm:leading-none pl-10 pt-10">
          <h1 class="inline-block relative">
            <span class="relative z-10">Market</span>
            <span class="absolute top-0 left-0 z-0 text-blue-400 opacity-50 blur-xl">
              Market
            </span>
          </h1>
        </div>
